...
| [Unified Change Plan](./unified-change-plan.md)                           | Immutable Codex Provider switch plans, additive v16 persistence, one-time admission, readback-derived jobs, reconciliation, IPC, and renderer entry routing.                                                                       |
