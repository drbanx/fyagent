...
| [External Agent P0 Safety](./external-agent-p0.md)                        | Catalog v3 (TRAE Work CN URL), runtime/launch authority, Skills including WorkBuddy, Qoder Hooks, TRAE GET observation/`state.vscdb`, OpenCode `opencode.json` persist, narrow permissions, and secret boundaries.                    |
