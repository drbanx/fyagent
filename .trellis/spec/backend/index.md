...
| Guide                                                                     | Use it for                                                                                                                                         |
| ------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Codex Desktop Installer](./codex-desktop-installer.md)                   | Fixed-source installer service, IPC DTOs/job events, frozen Shell-user package ownership, narrow current-user helper, and trusted restart/launch.  |
...
| [Windows Runtime Security](./windows-runtime-security.md)                 | Frozen Explorer-user identity and paths, Alice-owned Tauri state, untrusted single-instance input, and elevated CLI boundary.                      |
