...
| [V2 Skills and MCP Feature Contract](./v2-skills-mcp.md)                   | Six V2 Skill targets, four direct MCP targets, WorkBuddy copy/`.mcp.json`, leftover backend flags, authoritative state, secret handling, and responsive UI.    |
