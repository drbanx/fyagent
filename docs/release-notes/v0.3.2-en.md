...
> before installing.
>
> The v0.3.2 publication contract requires exactly 14 non-empty attachments:
...
- **Windows installers move from MSI to NSIS:** v0.3.2 provides
...
```text
FyAgent-0.3.2-Windows-x64-setup.exe
FyAgent-0.3.2-Windows-arm64-setup.exe
```
...
```text
FyAgent-0.3.2-macOS.dmg
FyAgent-0.3.2-macOS.zip
```
...
```text
FyAgent-0.3.2-Linux-x86_64.AppImage
FyAgent-0.3.2-Linux-x86_64.deb
FyAgent-0.3.2-Linux-x86_64.rpm
FyAgent-0.3.2-Linux-arm64.AppImage
FyAgent-0.3.2-Linux-arm64.deb
FyAgent-0.3.2-Linux-arm64.rpm
```

Flatpak remains a local diagnostic conversion and is not a formal v0.3.2
installer.
...
See the
[installation guide](https://github.com/fy-agent/fyagent/blob/v0.3.2/docs/user-manual/en/1-getting-started/1.2-installation.md)
...
at its original commit. It was not moved, deleted, or reused. FyAgent v0.3.2 is
the first formal publication of the Windows current-user runtime, NSIS
installer, CI, release, tooling, and documentation changes described above.
...
See
[LICENSE](https://github.com/fy-agent/fyagent/blob/v0.3.2/LICENSE),
[LICENSING.md](https://github.com/fy-agent/fyagent/blob/v0.3.2/LICENSING.md),
and
[THIRD_PARTY_NOTICES.md](https://github.com/fy-agent/fyagent/blob/v0.3.2/THIRD_PARTY_NOTICES.md).
