...
Some Claude Code and Codex provider cards show a **Local Routing support badge**, helping you quickly identify providers that can be served through local routing.
