...
const longTermMemorySeeds = [
  ...
  {
    id: "openclaw-secondary-memory",
    category: "longTerm",
    toolId: "openclaw",
    sourceTargetId: "openclaw-secondary",
    title: "OpenClaw · 群聊长期记忆",
    sourceLabel: "自定义工作区 · secondary",
    purpose: "群聊前台独立的长期上下文",
    path: "~/.openclaw/workspace-secondary/MEMORY.md",
    storageKind: "Markdown",
    content:
    ...
    itemCount: 1,
    updatedAt: "示例数据",
    syncTargetIds: ["openclaw-secondary"],
    localState: "saved-preview",
    owner: "memory",
  },
  {
...
const dailyMemorySeeds = [
  {
    ...
    sourceTargetId: "openclaw-default",
    title: "OpenClaw · 今日记录",
    sourceLabel: "默认工作区 · 示例日期/专题文件",
    purpose: "按日期保存的工作痕迹与短期上下文",
    path: "~/.openclaw/workspace/memory/<date>.md",
    storageKind: "Markdown",
    content:
      "# <date>\n\n这是稳定的前端示例结构；联调后再从经过授权的数据源读取正文。",
    writable: true,
    searchable: true,
    itemCount: 4,
    updatedAt: "示例数据",
  ...
  },
  {
    ...
    path: "~/.config/opencode/memory/<date>.md",
    storageKind: "Markdown",
    content:
  ...
  },
  {
    ...
    path: "~/.openclaw/workspace-secondary/memory/<date>.md",
    storageKind: "Markdown",
    content: "# 群聊记录\n\n群聊前台的每日记录与默认工作区分开保存。",
    writable: true,
    searchable: true,
...
const sessionSourceSeeds = [
  ...
  },
  {
    ...
    sourceLabel: "示例 transcripts · 项目 JSONL",
  ...
  {
    id: "openclaw-secondary-sessions",
    category: "sessions",
    toolId: "openclaw",
    sourceTargetId: "openclaw-secondary",
    title: "OpenClaw · secondary 会话",
    sourceLabel: "5 个主会话 + trajectory",
    purpose: "群聊前台的独立会话与轨迹",
    path: "~/.openclaw/agents/secondary/sessions/",
    storageKind: "JSONL",
    content:
      "# OpenClaw secondary 会话\n\n这是独立 workspace 的示例，不能与 main / utility 合并来源。",
    writable: false,
    searchable: true,
    itemCount: 2,
    updatedAt: "示例数据",
  ...
  },
  {
    ...
    sourceLabel: "示例 SQLite session · JSON session",
